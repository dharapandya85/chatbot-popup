...
exports.AccountMentionsAction = exports.AccountMentionsInput = void 0;
exports.accountMentions = accountMentions;
 ...
 */
exports.AccountMentionsInput = zod_1.z
    .object({
    userId: zod_1.z
        .string()
 ...
 */
async function accountMentions(client, args) {
    try {
 ...
 */
class AccountMentionsAction {
    constructor() {
        this.name = "account_mentions";
        this.description = ACCOUNT_MENTIONS_PROMPT;
        this.argsSchema = exports.AccountMentionsInput;
        this.func = accountMentions;
    }
}
exports.AccountMentionsAction = AccountMentionsAction;
