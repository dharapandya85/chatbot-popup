...
exports.PythFetchPriceAction = exports.PythFetchPriceInput = void 0;
 ...
 */
exports.PythFetchPriceInput = zod_1.z.object({
 ...
 */
async function pythFetchPrice(args) {
 ...
 */
class PythFetchPriceAction {
    constructor() {
        this.name = "pyth_fetch_price";
        this.description = PYTH_FETCH_PRICE_PROMPT;
        this.argsSchema = exports.PythFetchPriceInput;
        this.func = pythFetchPrice;
    }
}
exports.PythFetchPriceAction = PythFetchPriceAction;
