...
exports.TransferNftAction = exports.TransferNftInput = void 0;
 ...
 */
exports.TransferNftInput = zod_1.z
    .object({
 ...
 */
async function transferNft(wallet, args) {
...
class TransferNftAction {
    constructor() {
        this.name = "transfer_nft";
        this.description = TRANSFER_NFT_PROMPT;
        this.argsSchema = exports.TransferNftInput;
        this.func = transferNft;
    }
}
exports.TransferNftAction = TransferNftAction;
