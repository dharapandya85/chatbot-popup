...
exports.MintNftAction = exports.MintNftInput = void 0;
 ...
 */
exports.MintNftInput = zod_1.z
    .object({
    contractAddress: zod_1.z.string().describe("The contract address of the NFT to mint"),
    destination: zod_1.z.string().describe("The destination address that will receive the NFT"),
})
    .strip()
 ...
 */
async function mintNft(wallet, args) {
    const mintArgs = {
        to: args.destination,
        quantity: "1",
    };
...
class MintNftAction {
    constructor() {
        this.name = "mint_nft";
        this.description = MINT_NFT_PROMPT;
        this.argsSchema = exports.MintNftInput;
        this.func = mintNft;
    }
}
exports.MintNftAction = MintNftAction;
